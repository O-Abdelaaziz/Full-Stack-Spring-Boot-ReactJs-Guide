...
const BookForm = (props) => {
    ...
    useEffect(()=>{
            ...
            isbnInputRef.current.value = book?.isbn
            authorInputRef.current.value = book?.author
            editionInputRef.current.value = book?.edition
            priceInputRef.current.value = book?.price
            quantityInputRef.current.value = book?.quantity
            ratingInputRef.current.value = book?.rating
            publishDateInputRef.current.value = book?.publish
            tagsInputRef.current.value = book?.tags
            descriptionInputRef.current.value = book?.description
        }
        ,[book]
    )
